...
@Path("/fileBancoDadosColetas")
public class BancoFilesColetasRest {

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public List<MetricaTO> listaMetricas(@QueryParam("idArquivo") Integer idArquivo,  @QueryParam("inicio") String strInicio, @QueryParam("fim") String strFim ) {
